...
always@(posedge signal_DebuggerClk) begin
   if(signal_DebuggerBegin) begin
	  ...
	  if(^{red_golden,green_golden,blue_golden} !== 1'bx) begin
         ...
         //Vennsa VPI Function
         $vennsa_setReferenceValue(red, red_golden);
         $vennsa_setReferenceValue(green, green_golden);
         $vennsa_setReferenceValue(blue, blue_golden);
      ...
      if(^{wb_data_o_golden, wb_addr_o_golden} !== 1'bx) begin

         //Vennsa VPI Function
         $vennsa_setReferenceValue(wb_data_o, wb_data_o_golden);
         $vennsa_setReferenceValue(wb_addr_o, wb_addr_o_golden);
      ...
      if(^{hsync_golden, vsync_golden, csync_golden, blanc_golden} !==1'bx) begin

         //Vennsa VPI Function
         $vennsa_setReferenceValue(hsync, hsync_golden);
         $vennsa_setReferenceValue(vsync, vsync_golden);
         $vennsa_setReferenceValue(csync, csync_golden);
         $vennsa_setReferenceValue(blanc, blanc_golden);
